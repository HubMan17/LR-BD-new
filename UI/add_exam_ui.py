...
################################################################################
## Form generated from reading UI file 'add_exam_ui.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_3.setGeometry(QRect(12, 70, 160, 22))
        font = QFont()
        ...
        self.lineEdit.setGeometry(QRect(12, 40, 160, 22))
        self.lineEdit.setFont(font)
        self.lineEdit.setReadOnly(True)
        self.lineEdit_2 = QLineEdit(Form)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(180, 40, 290, 22))
        self.lineEdit_2.setFont(font)
        self.lineEdit_4 = QLineEdit(Form)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(10, 100, 291, 22))
        self.lineEdit_4.setFont(font)
        self.lineEdit_4.setReadOnly(True)
        self.textEdit = QTextEdit(Form)
        self.textEdit.setObjectName(u"textEdit")
        self.textEdit.setGeometry(QRect(10, 130, 290, 141))
        self.textEdit.setFont(font)
        self.comboBox = QComboBox(Form)
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(180, 70, 290, 22))
        self.comboBox.setFont(font)
        self.pushButton = QPushButton(Form)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(430, 290, 121, 51))
        self.scrollArea = QScrollArea(Form)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setGeometry(QRect(320, 130, 291, 141))
